...
function renderjobs(filter = "all") {
  ...
  filterJob.forEach((job, index) => {
    ...
    console.log(mainDataIndex);
    const div = document.createElement("div");
    div.innerHTML = `
    <div class="w-full bg-white rounded-xl p-6 flex flex-col gap-5">
            ...
            <div>
              <span
                class="bg-[#EEF4FF] px-3 py-2 text-black text-sm font-medium rounded-[4px]"
                >${job.status}</span
              >
